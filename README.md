...
$$
\operatorname{Payout} = \max\left(₹50, \frac{\operatorname{Weekly Income}}{\operatorname{Working Hours}} \times \operatorname{Lost Hours} \times \operatorname{Plan Factor}\right)
$$
